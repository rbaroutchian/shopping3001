# Generated by Django 6.0.3 on 2026-06-20 15:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(max_length=500, verbose_name='لینک')),
                ('footer_link_box', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links', to='site_modules.footerlinkbox', verbose_name='دسته بندی')),
            ],
            options={
